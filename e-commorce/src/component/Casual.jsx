...
const Casual = () => {
  const {
    ...
    queryKey: ["casual"],
    queryFn: fetchCasualProducts,
    staleTime: 3 * 60 * 1000,
  });

  if (isLoading) return <p className="text-center py-10">Loading...</p>;
  if (isError) {
    toast.error("Failed to load casuals products.", { autoClose: 2000 });
    return (
      <p className="text-center py-10 text-red-500">Failed to load casuals products</p>
    );
  }
